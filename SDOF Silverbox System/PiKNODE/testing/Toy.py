...
mdl_DMD.load_state_dict(checkpoint['mdl_DMD']) 
...
train(mdl_DMD, mdl_hysteresis, x, dx, ddxg, epochs, writer, source_seq, target_seq, dt, open_loop_horizon, x_mean, x_std, dx_mean, dx_std, ddxg_mean, ddxg_std)
