...
def train(mdl_DMD, mdl_hysteresis, x, dx, ddxg, epochs, writer, source_seq, target_seq, dt, open_loop_horizon = None):
    ...
    for epoch in tqdm(range(epochs)):
        ...
        loss_x_tr, loss_dx_tr, loss_hys_tr, loss_ae_tr, loss_koopman_tr, z_t_1_seq_tr_pred, x_t_1_seq_tr_pred, dx_t_1_seq_tr_pred = full_forward_pass(mdl_DMD,
        ...
        ## val forward pass
        with torch.no_grad():
            loss_x_val, loss_dx_val, loss_hys_val, loss_ae_val, loss_koopman_val, z_t_1_seq_val_pred, x_t_1_seq_val_pred, dx_t_1_seq_val_pred = full_forward_pass(mdl_DMD,
    ...
    # save mdl_DMD
    save_dict = {}
    save_dict['mdl_DMD'] = mdl_DMD.state_dict()
...
def full_forward_pass(mdl_DMD, mdl_hysteresis, x_t_seq, x_t_1_seq, dx_t_seq, dx_t_1_seq, ddxg_t_seq, ddxg_t_1_seq, target_seq, dt, x_mean, x_std,
     dx_mean, dx_std, ddxg_mean, ddxg_std, loss_fn):
