...
## functions
def train(mdl_LSTM, x, dx, ddxg, epochs, writer, source_seq, target_seq, x_mean = None, x_std = None, dx_mean = None,
...
def comprehensive_forward_pass(mdl_LSTM, mdl_hysteresis, x_t_seq, x_t_1_seq, dx_t_seq, dx_t_1_seq, ddxg_t_seq, ddxg_t_1_seq, target_seq, dt, x_mean, x_std,
     dx_mean, dx_std, ddxg_mean, ddxg_std, loss_fn):
    # target sequence prediction 
    z_t_1_seq_pred, x_t_1_seq_pred, dx_t_1_seq_pred = seq_pred(mdl_LSTM, mdl_hysteresis, x_t_seq, dx_t_seq, ddxg_t_seq, ddxg_t_1_seq, target_seq, dt, x_mean, x_std,
     dx_mean, dx_std, ddxg_mean, ddxg_std)
    ...
    # autoencoder loss
    H_X_t = mdl_LSTM.encoder_forward(z_t, mdl_LSTM.encoder_list_states)
    z_t_ae = mdl_LSTM.decoder_forward(H_X_t, mdl_LSTM.decoder_list_states)
    ...
    H_U_t = mdl_LSTM.encoder_forward(U_t, mdl_LSTM.encoder_list_control) 
    H_X_t_1 = mdl_LSTM.Koopman_control(H_X_t, H_U_t)
